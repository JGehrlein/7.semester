...
```{r}
df_fly_13 <- data.frame(c(0,km$time[1:8]),c(1,km$surv[1:8]),c(0,km$std.err[1:8]))
colnames(df_fly_13) <- c('Time','Surv','Std.error')
df_fly_20 <- data.frame(c(0,km$time[9:16]),c(1,km$surv[9:16]),
                        c(0,km$std.err[9:16]))
colnames(df_fly_20) <- c('Time','Surv','Std.error')
df_OP50 <- data.frame(c(0,km$time[17:24]),c(1,km$surv[17:24]),
                        c(0,km$std.err[17:24]))
...
df_fly_13 <- data.frame(c(0,km1$time[1:7]),c(1,km1$surv[1:7]),
                        c(0,km1$std.err[1:7]))
colnames(df_fly_13) <- c('Time','Surv','Std.error')
df_fly_20 <- data.frame(c(0,km1$time[8:15]),c(1,km1$surv[8:15]),
                        c(0,km1$std.err[8:15]))
colnames(df_fly_20) <- c('Time','Surv','Std.error')
df_OP50 <- data.frame(c(0,km1$time[16:24]),c(1,km1$surv[16:24]),
                        c(0,km1$std.err[16:24]))
colnames(df_OP50) <- c('Time','Surv','Std.error')
...
df_fly_13 <- data.frame(c(0,km2$time[1:7]),c(1,km2$surv[1:7]),c(0,km2$std.err[1:7]))
colnames(df_fly_13) <- c('Time','Surv','Std.error')
df_fly_20 <- data.frame(c(0,km2$time[8:12]),c(1,km2$surv[8:12]),
                        c(0,km2$std.err[8:12]))
colnames(df_fly_20) <- c('Time','Surv','Std.error')
df_OP50 <- data.frame(c(0,km2$time[13:20]),c(1,km2$surv[13:20]),
                        c(0,km2$std.err[13:20]))
colnames(df_OP50) <- c('Time','Surv','Std.error')
