...
NMDS <- amp_ordinate(data, type = 'NMDS', distmeasure = 'none',
                      detailed_output = TRUE, transform = 'none',
                       k = 10, try = 20, trymax = 50,
                      filter_species = 0, sample_color_by = col_v[2])
NMDS$plot
...
NMDS <- amp_ordinate(data, type = 'NMDS', distmeasure = 'none',
                      detailed_output = TRUE, transform = 'none',
                       k = 10, try = 20, trymax = 50,
                      filter_species = 0, sample_color_by = col_v[3])
NMDS$plot
...
NMDS <- amp_ordinate(data, type = 'NMDS', distmeasure = 'none',
                      detailed_output = TRUE, transform = 'none',
                       k = 10, try = 20, trymax = 50,
                      filter_species = 0, sample_color_by = col_v[4])
NMDS$plot
...
NMDS <- amp_ordinate(data, type = 'NMDS', distmeasure = 'none',
                      detailed_output = TRUE, transform = 'none',
                       k = 10, try = 20, trymax = 50,
                      filter_species = 0, sample_color_by = col_v[5])
NMDS$plot
